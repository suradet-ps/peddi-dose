...
export function ResultCard({ result, isManualMode, weightValidation }: ResultCardProps) {
  if (result === null) {
    if (weightValidation.status === 'error' && weightValidation.message !== null) {
      return (
        <div className="result result--empty result--error" role="alert">
          <svg
            width="28"
            height="28"
            viewBox="0 0 24 24"
